...
RSpec.describe Changer do
  context "denomination enumeration" do
    ...
    it "handles zero correctly" do
      changer = Changer.new(0)

      denominations, string_result = changer.get_denominations
      expect(denominations).to be_empty
      expect(string_result).to be_empty
    end
  end

  context "pluralization helper" do
